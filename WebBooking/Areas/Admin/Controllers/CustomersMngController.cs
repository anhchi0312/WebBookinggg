...
{
    public class CustomersMngController : Controller
    {
        private DBconect db = new DBconect();

        // GET: Admin/CustomersMng
        public ActionResult Index()
        {
            return View(db.Customers.ToList());
        }

        // GET: Admin/CustomersMng/Details/5
        ...
        // GET: Admin/CustomersMng/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Admin/CustomersMng/Create
        ...
        // POST: Admin/CustomersMng/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Admin/CustomersMng/Delete/5
        ...
        // POST: Admin/CustomersMng/Delete/5
